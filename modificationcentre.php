...
// de la base (en appelant la fonction obtenirDetailcentre) sinon on 
...
else
{
   ...
   if (nbErreurs()==0)
   {        
      modifiercentre($connexion, $id, $nom, $adresseRue, $codePostal, $ville, 
...
echo "
<form method='POST' action='modificationcentre.php?'>
