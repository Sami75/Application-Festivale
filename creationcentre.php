...
else
{
   ...
   if (nbErreurs()==0)
   {        
      creercentre($connexion, $id, $nom, $adresseRue, $codePostal, $ville,  
...
echo "
<form method='POST' action='creationcentre.php?'>
   ...
   class='tabNonQuadrille'>
      ...
      <tr class="ligneTabNonQuad">
         <td> Téléphone*: </td>
         <td><input type="number" value="'.$tel.'" name="tel" size ="20" 
         maxlength="10"></td>
      </tr>
      <tr class="ligneTabNonQuad">
         <td> E-mail: </td>
         <td><input type="email" value="'.$adresseElectronique.'" name=
         "adresseElectronique" size ="75" maxlength="70" required placeholder="Entrer une adresse e-mail valide"</td>
      </tr>
      <tr class="ligneTabNonQuad">
         <td> Type*: </td>
         <td>';
   ...
   <table align='center' cellspacing='15' cellpadding='0'>
      ...
      <tr>
         <td colspan='2' align='center'><a href='listecentres.php'>Retour</a>
         </td>
      </tr>
   </table>
</form>";
